...
ATTR_FANS = {
    "USER":               (60,  200),
    "SESSION":            (20,  160),
    "SECURITY_AUDIT":     (-20, 160),
    "TOKEN_BLACKLIST":    (-60, 180),
    "CLIENT":             (120, 200),
    "CONSENT":            (150, 160),
    "AUTHORIZATION_CODE": (200, 160),
}
...
if __name__ == "__main__":
    ...
    make_png(os.path.join(pic_dir, "TAS-ER-Diagram-Chen.png"))
