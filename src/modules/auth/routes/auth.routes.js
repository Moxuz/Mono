...
const { rejectCrossOriginBrowserRequest } = require('../../../shared/middleware/csrf');

// Local authentication
router.post('/register',       rejectCrossOriginBrowserRequest, registerLimiter, validate(rules.register), authController.register);
router.post('/login',          rejectCrossOriginBrowserRequest, loginLimiter, validate(rules.login), authController.login);
...
router.post('/forgot-password', rejectCrossOriginBrowserRequest, forgotPasswordLimiter, validate(rules.forgotPassword), authController.forgotPassword);
router.post('/reset-password/:token', rejectCrossOriginBrowserRequest, forgotPasswordLimiter, validate(rules.resetPassword), authController.resetPassword);
